...
{/* sidebar end */}
              ...
              <div className='my-4'><h3 style={{textDecoration:'underline',display:'inline'}}>Football Venues</h3> <Button variant='outline-primary' className='ms-4' onClick={handleShowNew}> <FontAwesomeIcon icon={faCirclePlus} className='me-2' />Add</Button><FontAwesomeIcon icon={faCircleUser} className='float-end fs-1 mx-5 text-danger-emphasis userlogo rounded-circle' onClick={showLogout} /></div>
 {/* modal box*/}
